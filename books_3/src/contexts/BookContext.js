...
export const BookContext = React.createContext(); //iletmek isteyeceğimiz veri için bir yol oluşturuldu
...
//contexte ait provider ile state te bulunan veriyi aldık(67.satır)
